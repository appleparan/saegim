...
export async function addEngine(
  ...
  return api.post<OcrConfigResponse>(
    `/api/v1/projects/${projectId}/ocr-config/engines`,
    data,
  )
}
...
export async function deleteEngine(
  ...
  return api.delete(`/api/v1/projects/${projectId}/ocr-config/engines/${engineId}`) as Promise<OcrConfigResponse>
}
...
export async function setDefaultEngine(
  ...
  return api.put<OcrConfigResponse>(
    `/api/v1/projects/${projectId}/ocr-config/default-engine`,
    data,
  )
}
