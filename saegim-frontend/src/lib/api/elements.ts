...
import type { CreateElementRequest, UpdateElementRequest, ElementResponse } from './types'
...
export async function updateElement(elementId: string, data: UpdateElementRequest): Promise<void> {
