...
{#if attr}
  <div class="p-3 space-y-4">
    <h3 class="text-sm font-semibold text-foreground">페이지 속성</h3>
    ...
    <div class="border-t border-border pt-3 space-y-3">
      <h4 class="text-xs font-medium text-muted-foreground uppercase">특수 속성</h4>
...
{:else}
  <div class="p-3 text-center">
    <p class="text-sm text-muted-foreground py-8">페이지 데이터를 불러오는 중...</p>
  </div>
{/if}
