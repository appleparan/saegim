...
export function screenToImage(point: Point, stageX: number, stageY: number, scale: number): Point {
  return {
...
export function imageToScreen(point: Point, stageX: number, stageY: number, scale: number): Point {
  return {
