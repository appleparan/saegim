...
export function validateElement(element: LayoutElement): readonly ValidationError[] {
...
export function validateAnnotation(data: AnnotationData): readonly ValidationError[] {
  const errors: ValidationError[] = []
