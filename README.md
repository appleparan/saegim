...
**문서 업로드 & OCR** — PDF, 이미지 등 다양한 문서를 업로드하고 AI 기반 OCR로 텍스트를 자동 추출합니다.

**체계적 레이블링** — 팀원과 함께 문서 요소를 분류하고 레이블을 부여하여 데이터를 체계적으로 관리합니다.

**팀 협업** — 팀원과 역할을 관리하고, 작업을 할당하여 효율적으로 협업합니다.
